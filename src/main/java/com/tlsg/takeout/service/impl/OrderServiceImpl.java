...
import com.tlsg.takeout.entity.*;
import com.tlsg.takeout.mapper.OrderMapper;
import com.tlsg.takeout.service.*;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Orders> implements OrderService {
    ...
    public void submit(Orders orders) {
        ...
        AtomicInteger amount = new AtomicInteger(0); //AtomicInteger是一个提供原子操作的Integer类，通过线程安全的方式操作加减。
